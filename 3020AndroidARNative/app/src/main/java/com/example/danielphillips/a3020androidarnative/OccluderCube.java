...
public class OccluderCube extends Renderable{
    ...
    private final static String TAG = "OccluderCube";
    ...
    public void onDrawFrame() {
        ...
        GLES20.glDrawElements(GLES20.GL_TRIANGLES, sCubeIndices.length, GLES20.GL_UNSIGNED_SHORT, mIndicesBuffer);
